    ...
    <div className="bg-white shadow-sm rounded-lg flex">
      ...
      <div className='mx-3 my-2 w-full'>
        <div class="flex items-center justify-between w-full">
          <p className="text-gray-700 font-semibold text-md">{item.name}</p>
          <div>
            <div className="text-gray-600 hover:bg-gray-100 rounded-lg p-1 " onClick={() => {setIsMenuShown(!isMenuShown)}}>
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-48 z-20 rounded-lg shadow-lg bg-white border border-gray-200 p-1">
            <div className="p-2 rounded-lg font-semibold text-gray-500 text-md hover:text-[#6aa5ff] hover:bg-blue-50">Favorite</div>
            <div className="p-2 rounded-lg font-semibold text-gray-500 text-md hover:text-[#6aa5ff] hover:bg-blue-50">Hide</div>
          </div>
        </Transition>
            </div>
          </div>
        </div>
        <p className="text-gray-500 font-semibold text-sm">{item.module}</p>
        <p className="text-gray-500 font-semibold text-sm">{item.teacher}</p>
        <a href=""  className="text-[#6aa5ff] flex justify-end">View Course</a>
      </div>
    </div>
  )
}
