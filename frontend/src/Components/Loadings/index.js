		...
		<div className="fixed inset-0">
			...
			<div className="fixed inset-0 flex flex-col items-center justify-center z-10">
				<div className="relative">
					...
					<div className="p-2 bg-[#6aa5ff] text-white flex justify-center items-center rounded-xl ">
...
export function LoadingCard(){
	return (
		<div className="w-full flex flex-col space-y-3 animate-pulse">
			<div className="w-1/2 h-4 rounded-full bg-gray-200 dark:bg-zinc-700"></div>
			<div className="w-full h-4 rounded-full bg-gray-200 dark:bg-zinc-700"></div>
			<div className="w-full h-32 bg-gray-200 dark:bg-zinc-700"></div>
		</div>
	)
}