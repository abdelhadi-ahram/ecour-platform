...
export default function Card({item, index}){
  ...
  return(
    <div className="bg-white w-full dark:bg-zinc-800 shadow-sm border border-gray-200 dark:border-zinc-600 rounded-lg flex">
      ...
      <div className='mx-3 my-3 w-full'>
        ...
        <p className="text-gray-500 dark:text-gray-400 font-semibold text-sm truncate">{item.module.name}</p>
      </div>
    </div>
  )
}
