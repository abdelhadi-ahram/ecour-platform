...
export default function Card({item, index}){
  ...
  return(
    <div className="bg-white dark:bg-zinc-800 shadow-sm border border-gray-200 rounded-lg flex">
      ...
      <div className='mx-3 my-3 w-full'>
        <div class="flex items-center justify-between w-full">
          ...
          <div>
            <div className="text-gray-600 dark:text-gray-300 hover:bg-gray-100 rounded-lg p-1 " onClick={() => {setIsMenuShown(!isMenuShown)}}>
          ...
          <div className="absolute top-0 right-0 w-48 z-20 rounded-lg shadow-lg bg-white dark:bg-zinc-800 border border-gray-200 p-1">
            <div className="p-2 rounded-lg font-semibold text-gray-500 dark:text-gray-400 text-md hover:text-[#6aa5ff] hover:bg-blue-50">Favorite</div>
            <div className="p-2 rounded-lg font-semibold text-gray-500 dark:text-gray-400 text-md hover:text-[#6aa5ff] hover:bg-blue-50">Hide</div>
          </div>
        </Transition>
            </div>
          </div>
