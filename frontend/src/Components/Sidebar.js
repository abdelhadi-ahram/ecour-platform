...
export default function Sidebar(props){
  ...
  return(
    <div className="flex flex-col items-center bg-white shadow rounded-2xl h-full px-5 py-5">
      ...
      <div className="p-2 rounded-xl text-gray-400 hover:text-red-400 hover:bg-red-100" onClick={() => {setShowLogout(true)}}>
