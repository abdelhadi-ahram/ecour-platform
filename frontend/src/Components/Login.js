      ...
      <div className="w-[400px]">
        <div className="bg-white shadow-md rounded-2xl px-11 py-14 my-4">
          ...
          <div className="flex items-center space-x-2 ">
              ...
              <button className="w-full mt-4 bg-blue-400 hover:bg-blue-400 text-white text-lg my-4 py-2 px-4 rounded-lg border border-white focus:ring-1 focus:ring-blue-400">
                Login
              </button>
