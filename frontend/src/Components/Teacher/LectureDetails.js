...
function LectureDetails(){
	...
	return(
		...
		<div className="flex flex-col space-y-3">
			...
			<div className="w-full bg-white dark:bg-zinc-800 rounded-xl px-4 py-2 rounded shadow p-1">
