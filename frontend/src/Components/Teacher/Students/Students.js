...
function Students(){
	...
	return(
		<div className="flex flex-col space-y-2">
			<div className="py-1 sticky top-0 bg-gray-100 dark:bg-zinc-900">
		    		<div className="rounded-xl bg-white dark:bg-zinc-800 flex items-center justify-between overflow-hidden shadow p-1">
				        ...
				        <div className="text-gray-500 px-2">
				        	<div className="p-1 rounded-lg hover:bg-blue-50 dark:hover:bg-zinc-700 hover:text-blue-400 dark:hover:text-blue-500">
			...
			<tr className="p-2 bg-white dark:bg-zinc-800">
				<td className="text-gray-900 dark:text-gray-300 fnt-semibold p-2">Full name</td>
				<td className="text-gray-900 dark:text-gray-300 fnt-semibold p-2">CIN</td>
				<td className="text-gray-900 dark:text-gray-300 fnt-semibold p-2">Absence</td>
				<td className="text-gray-900 dark:text-gray-300 fnt-semibold p-2">Homeworks</td>
				<td className="text-gray-900 dark:text-gray-300 fnt-semibold p-2">Action</td>
			</tr>
			{
				STUDENTS.map((item, index) => {
					return (
						<tr className={`p-2 ${index % 2? "bg-white dark:bg-zinc-800" : "bg-gray-50 dark:bg-zinc-700"}`} key={`${item}-${index}`}>
							<td className="text-gray-500 dark:text-gray-300 p-2">{item.name}</td>
							<td className="text-gray-500 dark:text-gray-300 p-2">{item.cin}</td>
							<td className="text-gray-500 dark:text-gray-300 p-2">{item.absence}</td>
							<td className="text-gray-500 dark:text-gray-300 p-2">{item.homeworks}</td>
