		...
		<div className="bg-white dark:bg-zinc-800 rounded-md px-4 flex flex-col space-y-3 py-4 shadow">
			<div className="w-full flex justify-between items-center space-x-4">
	            <div className="flex flex-col space-y-1 w-full">
	              ...
	              <div className="flex items-center space-x-3 w-full rounded border border-gray-200 dark:border-zinc-700 dark:text-gray-200 px-2 py-1 hover:border-gray-300 dark:hover:border-zinc-600">
				...
				<div className="flex flex-col space-y-1 w-full">
					...
					<div className="flex items-center space-x-3">
						<input onChange={handleChange} value={examData.duration} name="duration" type="time" className="w-full rounded bg-transparent border border-gray-200 dark:border-zinc-700 dark:text-gray-200 px-2 py-1 focus:outline-none hover:border-gray-300 dark:hover:border-zinc-600" />
					</div>
				</div>
				...
				<div className="flex flex-col space-y-1 w-full">
					...
					<div className="flex items-center space-x-3">
						<input onChange={handleChange} name="attempts" value={examData.attempts} type="number" className="w-full rounded bg-transparent border border-gray-200 dark:border-zinc-700 dark:text-gray-200 px-2 py-1 focus:outline-none hover:border-gray-300 dark:hover:border-zinc-600" />
					</div>
				</div>
	        ...
	        <div className="flex flex-col space-y-1 w-full">
              ...
              <input onChange={handleChange} name="title" value={examData.title} className="w-full rounded bg-transparent border border-gray-200 dark:border-zinc-700 dark:text-gray-200 px-2 py-1 focus:outline-none hover:border-gray-300 dark:hover:border-zinc-600" />
            </div>

            <div>
            	<p className="text-gray-600 dark:text-gray-400 font-semibold">Description</p>
            	<TextEditor height="150px" value={editorValue} setValue={setEditorValue} />
            </div>
