...
export default function LandingPageTopBar(props){
  ...
  return(
    <div className="w-full px-2">
        <div className="py-1 flex items-center justify-between">
            <p className="text-gray-800 dark:text-gray-200 font-semibold text-lg md:text-2xl">Ecole superieur de techonlogie</p>
