	        ...
	        <div className="w-full flex flex-col space-y-4">
	            ...
	            <div className="flex flex-col space-y-1 w-full">
	              ...
	              <div className="flex items-center space-x-3">
	              	<input value={date} onChange={(e) => setDate(e.target.value)} type="date" className="w-full rounded border border-gray-200 px-2 py-1 focus:outline-none hover:border-gray-300" />
	              	<input value={time} onChange={(e) => {setTime(e.target.value)}} type="time" className="w-full rounded border border-gray-200 px-2 py-1 focus:outline-none hover:border-gray-300" />
	            	</div>
	            </div>
	          </div>
	            ...
	            <div className="">
		            <div className="flex flex-col space-y-1">
		              <div className="flex justify-between items-center">
		              	<p className="text-gray-600 font-semibold">Content <span className="text-gray-400 text-sm">(drag and drop a file here)</span></p>
		              	{file && 
			              <div className="px-4 py-1 rounded-full bg-blue-50 flex justify-between items-center space-x-4 border-2 border-dashed border-blue-400">
		              ...
		              <Drag setDrag={setDrag} onDrop={onDrop}>
		              	<div className="relative">
		              		{
		              			drag && <div className="absolute inset-0 z-10 border-2 border-dashed border-blue-400 bg-blue-50 flex flex-col items-center justify-center space-y-2 rounded-lg">
		              				...
		              				<p className="text-gray-600 text-lg font-semibold">Drag and drop a file right here!</p>
		              			</div>
		              		}
	            ...
	            <div className="flex items-center justify-end">
	              ...
	              <button onClick={postData} className="px-4 py-[6px] text-white bg-blue-400 disabled:bg-blue-300 font-bold rounded-md text-md shadow border border-white focus:ring-1 focus:ring-blue-400 hover:shadow-lg">Post</button>
	            </div>
	        </div>
	      </div>
	    </div>
